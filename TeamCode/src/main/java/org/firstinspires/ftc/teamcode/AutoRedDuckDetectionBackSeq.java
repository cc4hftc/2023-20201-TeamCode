    ...
    public void runOpMode() {
        ...
        TrajectorySequence redBackLeftSpikeMark =
                drive.trajectorySequenceBuilder(startingPose)
                    ...
                    .waitSeconds(PIXELSERVOWAITSECS)
                    .addTemporalMarker(() -> {
                        claw1.setPower(0.0);
                        claw2.setPower(0.0);
                    })
        ...
        if ( spikeMark == 1 ) { // Left
            drive.followTrajectorySequence(redBackLeftSpikeMark);
        } else if ( spikeMark == 2 ) { // Center
            drive.followTrajectorySequence(redBackCenterSpikeMark);
        } else if ( spikeMark == 3 ) { // Right
            drive.followTrajectorySequence(redBackRightSpikeMark);
        } else { // No detection
            drive.followTrajectorySequence(redBackParkFromStartingPose);
        }
